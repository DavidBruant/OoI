/*
    Dirty copy/paste of other scripts.
 */
...
(function ({content, addMessageListener, sendAsyncMessage, removeMessageListener}) {
    ...
    throw 'THIS CANNOT WORK!!'
/*
    Ok. Here is the architecture I need to get to:
    * addon script that does not much if just dispatch scripts
    * when a tab is open: add the OoI tool to the toolbox
    * OoI toolbox tool content panel
    * OoI toolbox tool content panel content script ("this script")
    * ContentFrameMessageManager script inside the corresponding tab that will use the Debugger to inspect the tab content
    * content (which I do not write)
*/
