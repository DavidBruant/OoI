...
Debugger.Object.prototype.toString = function () {
    var object: Debugger.Object = this;
    var jsonableCopy = {};
...
export default function traverseGraph(window: Window, graph: SimpleGraph<any, any>) {
    ...
    const wg = globalDebugObject.getOwnPropertyDescriptor('window').get || (() => {});
    const windowProxyDebuggeeObject = wg.call(globalDebugObject).return;
    ...
    function hasDefaultPrototype(func: any, proto: any) {
            ...
            if (inspected instanceof Debugger.Object) {
                ...
                props.forEach(function (p) {
                    ...
                    if (value instanceof Debugger.Object) {
                        details = { dataProperty: p, defaultPrototype: false };
