declare module "sdk/system/events" {
    ...
    export function on(e: string, listener: (SystemEvent) => void , strong: boolean) : void
    export function on(e: "content-document-global-created", listener: (ContentDocumentGlobalCreatedSystemEvent) => void , strong: boolean) : void
}
