declare module "sdk/system/events" {
    ...
    export function on(e: string, listener: (e: SystemEvent) => void , strong: boolean) : void
    export function on(e: "content-document-global-created", listener: (c: ContentDocumentGlobalCreatedSystemEvent) => void , strong: boolean) : void
}
